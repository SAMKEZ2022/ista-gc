// FORCER LA LECTURE A CHAQUE FOIS
function getData(){
    return {
        ...
        USERS: JSON.parse(localStorage.getItem('USERS')) || [{ email: "admin@ista-gc.com", password: "admin123", role: "admin" }, { email: "prof.math@ista-gc.com", password: "1234", role: "prof" }, { email: "etudiant.gc@ista-gc.com", password: "1234", role: "etudiant" }]
    }
}
...
let {COURS, DEVOIRS, SUPPORTS, DEPOTS, USERS} = getData();
const currentUser = JSON.parse(localStorage.getItem('currentUser'));

// ACTUALISER TOUTES LES 2 SECONDES POUR VOIR LE LIVE
setInterval(() => {
    let newData = getData();
    COURS = newData.COURS; DEVOIRS = newData.DEVOIRS; SUPPORTS = newData.SUPPORTS; DEPOTS = newData.DEPOTS;
...
// TOUTES LES FONCTIONS LISENT AVEC getData()
